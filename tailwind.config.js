        ...
        extend: {
            ...
            keyframes: {
                cardHeaderKeyframeIn: {
                    '0%': {
                        transform:
                            'translateX(-10rem) translateY(10rem) rotate(-90deg)',
                        opacity: 1,
                    },
                    '40%': {
                        transform:
            ...
            animation: {
                cardHeaderAnimationIn:
                    'cardHeaderKeyframeIn 500ms ease-in-out forwards',
                cardHeaderAnimationOut:
                    'cardHeaderKeyframeOut 500ms ease-in-out forwards',
            },
        },
    },
    variants: {
